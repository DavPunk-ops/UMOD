...
*
* Objectif : logit direct P(KRU≥2) ~ UMOD + B2M, bootstrap Harrell,
*            stratégie à deux seuils (rule-out / rule-in).
*
* → manuscrit : "Diagnostic performance of combined serum uromodulin
*                and β2-microglobulin for predicting KRU ≥2 mL/min/35L"
*
* Section 1 : test formel exclusion âge/sexe.
* Sections 2–4 : MFP + logit direct + bootstrap + stratégie deux seuils.
* ===========================================================================
